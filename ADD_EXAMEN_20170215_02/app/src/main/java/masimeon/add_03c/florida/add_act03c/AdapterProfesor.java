...
public class AdapterProfesor extends ArrayAdapter {
    ...
    public AdapterProfesor(Context contexto, Activity activity, ArrayList<Profesor> arraylist, MyDBAdapter db) {
